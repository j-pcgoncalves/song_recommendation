...
def run_program():
    ...
    def get_acoustic_song():
        if expertise.title() in level_of_expertise:
            acoustic_songs = list(acoustic_guitar[expertise.title()])
            random_song = random.choice(acoustic_songs)
            print()
            print('You should try learning: ' + random_song + '.')
    
    def get_electric_song():
        if expertise.title() in level_of_expertise:
            electric_songs = list(electric_guitar[expertise.title()])
    ...
    def get_bass_song():
        if expertise.title() in level_of_expertise:
            bass_songs = list(bass[expertise.title()])
    ...
    def get_drums_song():
        if expertise.title() in level_of_expertise:
            drums_songs = list(drums[expertise.title()])
    ...
    def get_piano_song():
        if expertise.title() in level_of_expertise:
            piano_songs = list(piano[expertise.title()])
